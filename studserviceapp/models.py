...
class Grupa(models.Model):
    ...
    def __str__(self):
        return self.oznaka_grupe + " " + self.smer
...
class Student(models.Model):
    ...
    slika = models.ImageField(upload_to='profile_image', blank=True)

    def __str__(self):
        return self.ime + " " + self.prezime + " " + str(self.broj_indeksa) + "/" + str(self.godina_upisa)
...
class Termin(models.Model):
    ...
    def __str__(self):
        return self.predmet.naziv + ": " + self.oznaka_ucionice +\
               " [" + self.dan + " " + str(self.pocetak) + " - " + str(self.zavrsetak) + "]"
...
class IzbornaGrupa(models.Model):
    ...
    def __str__(self):
        return self.oznaka_grupe + ", " + self.smer + ", " + str(self.aktivna)
...
# RasporedPolaganja i TerminPolaganja koji su povezani vezom jedan prema vise preko stranog kljuca
...
class Obavestenje(models.Model):
    ...
    fajl = models.FileField(upload_to='obavestenja', blank=True)

    def __str__(self):
        return 'Postavio: ' + self.postavio.username
